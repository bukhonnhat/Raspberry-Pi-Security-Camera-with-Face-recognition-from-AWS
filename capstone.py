...
s3 = boto3.client('s3',aws_access_key_id='AKIAJ5GZXZVQPB35353Q', #create s3 client
                      aws_secret_access_key='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',
                      region_name='us-east-1')
rekog = boto3.client('rekognition',                               #create rekognition client
                         aws_access_key_id='AKIA42FYQYTCEOZLVED7',
                         aws_secret_access_key='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',
                         region_name='us-east-1'
                    )
ses = boto3.client('ses',aws_access_key_id='AKIAJ5GZXZVQPB35353Q',# create ses client
                      aws_secret_access_key='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',
                      region_name='us-east-1')
i =0
def capture():
    global i
    cv2.imwrite("test%s.jpg"%i,frame)
    upload('test%s.jpg'%i)
    time.sleep(1)
    email(i)
    i+=1
